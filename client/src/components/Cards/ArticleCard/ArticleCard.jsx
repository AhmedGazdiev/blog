...
const ArticleCard = ({ id, title, content, createdAt, scrollTop }) => {
  return (
    <Link to={`/articlecard/${id}`} className="article-card">
      <Heading type="pink">Многие думают, что Lorem Ipsum</Heading>
      <span className="fs-12">17 декабря 2022 г.</span>
      <p className="fs-16">Ричард МакКлинток, профессор латыни из колледжа Hampden-Sydney, штат Вирджиния, взял одно из самых странных слов в Lorem Ipsum</p>
